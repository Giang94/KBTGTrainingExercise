// ShippingAddressForm.test.js
import React from 'react';
import { shallow } from 'enzyme';
import ShippingAddressForm from '../containers/ShippingAddress/ShippingAddressForm';

describe('Shipping Address', () => {
  let wrapper;
  beforeEach(() => wrapper = shallow(<ShippingAddressForm />));
